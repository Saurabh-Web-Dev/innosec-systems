 ...
 <!-- Carousel Start -->
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-10 text-start">
                                    <p class="fs-5 fw-medium text-primary text-uppercase animated slideInRight">14 Years of Working Experience</p>
                                    <h1 class="display-1 text-white mb-5 animated slideInRight">Professional Installation Team</h1>
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    ...
                    <div class="d-flex align-items-center mb-4">
                        ...
                        <div class="ms-4">
                            <p><i class="fa fa-check text-primary me-2"></i>Fire Fighting Equipment</p>
                            <p><i class="fa fa-check text-primary me-2"></i>Fire Alarm System</p>
                            <p><i class="fa fa-check text-primary me-2"></i>Wireless Smoke Detector</p>
                            <p><i class="fa fa-check text-primary me-2"></i>Access Control System</p>
                            <p class="mb-0"><i class="fa fa-check text-primary me-2"></i>Wireless Alarm System</p>
                        </div>
                    </div>
                    <div class="row pt-2">
                        <div class="col-sm-6">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-3">
                                    ...
                                    <h6 class="mb-0">innosecsystems@gmail.com</h6>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-3">
                                    ...
                                    <h6 class="mb-0"><a href="tel:+919711408978">+91 9711408978</a></h6>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row g-5">
            <div class="col-md-6 col-xl-3 wow fadeIn" data-wow-delay="0.1s">
                <div class="text-center border p-5">
                    ...
                    <h1 class="display-2 text-primary mb-0" data-toggle="counter-up">14</h1>
            ...
            <div class="col-md-6 col-xl-3 wow fadeIn" data-wow-delay="0.5s">
                <div class="text-center border p-5">
                    ...
                    <h1 class="display-2 text-primary mb-0" data-toggle="counter-up">292</h1>
            ...
            <div class="col-md-6 col-xl-3 wow fadeIn" data-wow-delay="0.7s">
                <div class="text-center border p-5">
                    ...
                    <h1 class="display-2 text-primary mb-0" data-toggle="counter-up">805</h1>
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    ...
                    <p class="mb-4">Innosec Systems, New Delhi, is a top electronic security provider with 15+ years of experience, offering quality fire safety and access control solutions across India. We specialize in manufacturing and trading high-quality Fire Fighting Equipment, Fire Alarm Systems, Access Control Systems, and more, serving both corporate and government clients.</p>
                    <div class="row gy-4">
                        <div class="col-12">
                            <div class="d-flex">
                                <div class="flex-shrink-0 btn-lg-square rounded-circle bg-primary">
                                ...
                                <div class="ms-4">
                                    ...
                                    <span>Our team consists of highly skilled professionals with over 15 years of experience in the electronic security industry, ensuring reliable service and expert solutions for every project.</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="d-flex">
                                ...
                                <div class="ms-4">
                                    ...
                                    <span>We deliver dependable and efficient electronic security and fire safety solutions tailored to meet the rigorous demands of industrial, corporate, and government sectors.</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="d-flex">
                                ...
                                <div class="ms-4">
                                    ...
                                    <span>We offer round-the-clock customer support to ensure your security systems run smoothly and any issues are resolved promptly—anytime, anywhere.</span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container-fluid bg-dark pt-5 my-5 px-0">
        <div class="text-center mx-auto mt-5 wow fadeIn" data-wow-delay="0.1s" style="max-width: 600px;">
            <p class="fw-medium text-uppercase text-primary mb-2">Our Trending Products</p>
